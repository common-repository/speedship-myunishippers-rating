...
define('SPEED_RAD_MAIN_FILE', __FILE__);
 ...
 */
function speed_en_res_add_address_script_load()
{
    /** Register scripts */
 ...
 */
add_action('admin_enqueue_scripts', 'speed_en_res_add_address_script_load');

/**
 * Define constants
 */
define('speed_addon_plugin_url', __DIR__);
