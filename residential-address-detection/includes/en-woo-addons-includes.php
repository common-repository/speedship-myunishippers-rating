...
if (!class_exists("EnWooAddonsInclude")) {
    ...
    class EnWooAddonsInclude extends EnWooAddonPluginDetail
    {
        ...
        public function en_woo_addons_load_common_files()
        {
            ...
            include_once(speed_addon_plugin_url . '/includes/en-woo-addons-ajax-request.php');
            include_once(speed_addon_plugin_url . '/includes/en-woo-addons-forms-handler.php');
        }
