 ...
 */
add_action('admin_footer', 'speed_en_rad_address_scripting_table');

/**
 * JS
 */
function speed_en_rad_address_scripting_table()
{
?>
    ...
    <script>
        function en_rad_address_zip_change() {
            ...
            if (zip_code && !regex_zip.test(zip_code)) {
                ...
                jQuery("#en_residential_addresses_form").css({
                    'border-color': '#e81123'
                });
                jQuery('.en_res_popup_content').delay(200).animate({
                    scrollTop: 0
                }, 300);
                setTimeout(function() {
