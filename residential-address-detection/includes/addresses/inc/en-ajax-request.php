...
class SpeedEnRadAddressAjax
{
    ...
    {
        update_option('en_default_unconfirmed_address_types_to', sanitize_text_field($_POST['en_default_unconfirmed_selected_address_types_to']));
        echo wp_json_encode([]);
        exit;
    }
    ...
    public function en_rad_save_address_list()
    {
        ...
        $en_res_address_form_data =  sanitize_text_field($_POST["formData"]);
        $addr_hidden =  sanitize_text_field($_POST["address_rad"]);
    ...
    public function en_rad_delete_address()
    {
        ...
        $en_res_address_form_id = sanitize_text_field($_POST["form_del_id"]);
        $addr_hidden =  sanitize_text_field($_POST["address_rad_del"]);
    ...
    public function en_rad_small_address($speed_map_address, $access_level, $destination_zip = array())
    {
        ...
        $en_rad_http_response = new SpeedEnRadHttpResponse();
    ...
    public function get_rad_address_api_ajax()
    {
        if (isset($_POST['res_addr_zip'])) {
            $speed_map_address = (isset($_POST['res_addr_zip'])) ? sanitize_text_field($_POST['res_addr_zip']) : "";
    ...
    /* ========= End Class SpeedEnRadAddressAjax ========== */
}

new SpeedEnRadAddressAjax();
