<?php
add_action('woocommerce_settings_wc_settings_quote_section_end_residential_addresses_after', 'speed_en_woo_addons_end_residential_addresses_table');

function speed_en_woo_addons_end_residential_addresses_table()
{
?>
        ...
        <center>
            ...
            <table id="en_residential_address_table" class="en_residential_address_table" border="1px" style="border-collapse:collapse;">
                ...
                ?>
                        ...
                        <tr id="row_<?php echo esc_attr($res_addr_postId); ?>">
                            ...
                            ?>
                                        <td class="en_res_data txt-upper"><?php echo esc_html($value); ?></td>
                                    <?php
                                    } else if ($key == "en_address_type") {
                                    ?>
                                        <td class="en_res_data txt-capital"><?php echo esc_html($value); ?></td>
                                    <?php
                                    } else {
                                    ?>
                                        <td class="en_res_data"><?php echo esc_html($value); ?></td>
                                    <?php
                                    }
                                    ?>
                            <?php
                            ...
                            <td class="en_res_data">
                                <a class="en_res_icon_link" onclick="return en_rad_edit_address(<?php echo (isset($res_addr_postId)) ? $res_addr_postId : ''; ?>);"><img class="edit-icon" src="<?php echo plugins_url('imgs/edit.png', __FILE__); ?>" title="Edit"></a>
                                <a class="en_res_icon_link" onclick="return en_rad_delete_current_address(<?php echo (isset($res_addr_postId)) ? $res_addr_postId : ''; ?>);"><img src="<?php echo plugins_url('imgs/delete.png', __FILE__); ?>" title="Delete"></a>
                            </td>
                        </tr>
