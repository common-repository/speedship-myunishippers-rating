        ...
        public function en_order_before_calculate_totals($and_taxes, $order)
        {
            ...
            if (isset($woocommerce->cart)) {
                    ...
                    foreach ($shipping as $item_id => $per_shipment) {
                        ...
                        switch ($method_id) {
                            case 'speedship':
                                ...
                                if (empty($errors)) {
                                    $shipping_class = new WC_speedship();
                ...
                if ($order_recreated) {
                    ...
                    $wwe_small_curl_obj = new Speed_Small_Package_Request();
                    $wwe_small_curl_obj->small_package_get_curl_response(SPEED_WWE_FDO_HITTING_URL, $request_data);
                }
            }
        }
    }
