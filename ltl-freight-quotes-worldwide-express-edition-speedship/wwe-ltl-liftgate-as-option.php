    ...
    class Wwe_Ltl_Liftgate_As_Option
    {
        ...
        public function update_rate_whn_as_option_wwe_ltl($rate)
        {
            ...
            if (isset($rate) && (!empty($rate))) {
                $rate = apply_filters("en_woo_addons_web_quotes", $rate, speed_en_woo_plugin_wwe_quests);
                ...
                if (
                    isset($this->wwe_ltl_as_option, $rate['grandTotalWdoutLiftGate']) &&
