 ...
 * Order widget page.
 */
if (!class_exists('SPEEDEnOrderWidget')) {

    class SPEEDEnOrderWidget
    {
        ...
        public function en_show_order_widget($number_shipment, $sender_origin, $label, $cost, $accessorials, $items, $en_extra_accessories)
        {
            ...
            echo '<h4 style="text-decoration: underline;margin: 4px 0px 4px 0px;">Shipment ' . esc_html($number_shipment) . " > Origin & Services </h4>";
            ...
            echo "</ul>";
            echo "<br>";
            echo '<h4 style="text-decoration: underline;margin: 4px 0px 4px 0px;">Shipment ' . esc_html($number_shipment) . " > items </h4>";
        ...
        public function en_show_accessorials($accessorials)
        {
            ...
            foreach ($accessorials as $accessorial => $status) {
                if ($status && isset($en_accessorials[$accessorial])) {
                    echo '<li>' . esc_html($en_accessorials[$accessorial]) . '</li>';
                }
            }
        }
