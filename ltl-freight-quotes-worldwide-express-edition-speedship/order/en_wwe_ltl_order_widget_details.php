...
if (!class_exists("En_WWE_Order_Widget_Details")) {
    ...
    class En_WWE_Order_Widget_Details
    {
        ...
        public function __construct()
        {
            ...
            $this->helper_obj = new En_Wwe_LTL_Helper_Class();
            $this->en_call_hooks();
        }
        ...
        function en_assign_order_details($actions)
        {
            ...
            if (!empty($this->result_details) && count($this->result_details) > 0) {
                ...
                add_meta_box('en_additional_order_details', __('Additional Order Details', 'woocommerce'), array($this, 'en_wwe_ltl_add_meta_box_order_widget'), 'shop_order', 'side', 'low', 'core');
            }
         ...
         */
        public function en_wwe_ltl_add_meta_box_order_widget()
        {
            $order_details = $this->get_formatted_meta_data;
            $this->en_wwe_ltl_origin_services_details($order_details);
        }
         ...
         */
        function en_wwe_ltl_origin_services_details($order_data)
        {
        ...
        public function show_order_widget_detail()
        {
            ...
            echo '<li>' . esc_attr($this->shipping_method_title) . esc_html($this->en_format_price($this->shipping_method_total)) . '</li>';
        ...
        function en_origin_services_details($order_data, $shipment_status, $ship_count, $single_price_details = array())
        {
            ...
            echo '<ul class="en-list" style="list-style: disc;list-style-position: inside;">';
            echo '<li>';
            echo ucwords(esc_html($service_order_data->origin->location)) . ', ';
