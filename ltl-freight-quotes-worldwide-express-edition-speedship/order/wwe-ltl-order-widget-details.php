...
if (!class_exists("en_wwe_ltl_view_Order_Widget_Details")) {
    class en_wwe_ltl_view_Order_Widget_Details
    {
        ...
        public function show_order_widget_detail()
        {
            ...
            echo esc_html($this->sender_origin);
            ...
            if (isset($this->_address) && is_string($this->_address) && strlen($this->_address) > 0) {
                echo '<li>' . esc_html($this->_shipping_method_title) . esc_html($this->_address) . ' ' . esc_html($this->en_format_price($this->shipping_method_total)) . '</li>';
            } else {
                echo '<li>' . esc_html($this->shipping_method_title) . esc_html($this->en_format_price($this->shipping_method_total)) . '</li>';
            }
            ...
            foreach (array_filter($this->product_name) as $product_str) {
                echo '<li>' . esc_html($product_str) . '</li>';
            }
    ...
    new en_wwe_ltl_view_Order_Widget_Details();
} 