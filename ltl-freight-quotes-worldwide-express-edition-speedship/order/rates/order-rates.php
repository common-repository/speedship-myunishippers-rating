 ...
 */
if (!class_exists('EnSpeedFreightOrderRates')) {

    class EnSpeedFreightOrderRates
    {
        ...
        public function en_order_before_calculate_totals($and_taxes, $order)
        {
            ...
            if (isset($woocommerce->cart)) {
                    ...
                    foreach ($shipping as $item_id => $per_shipment) {
                        ...
                        switch ($method_id) {
                            case 'ltl_shipping_method':
                                ...
                                if (empty($errors)) {
                                    $shipping_class = new WC_speedfreight_Shipping_Method();
                ...
                if ($order_recreated) {
                    ...
                    $wwe_ltl_curl_obj->wwe_ltl_get_curl_response(SPEED_WWE_FREIGHT_FDO_HITTING_URL, $request_data);
                }
            }
        }
    }

    new EnSpeedFreightOrderRates();
}
