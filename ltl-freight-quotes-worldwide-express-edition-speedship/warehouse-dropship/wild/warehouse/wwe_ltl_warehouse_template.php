...
<div class="en_wd_setting_section">
    ...
    <?php wwe_ltl_warehouse_template(); ?>
            ...
            <div class="content" style="overflow-y: scroll; height: 500px;">
                ...
                <form method="post" id="add_warehouses">
                    ...
                    <div class="en_wd_add_warehouse_input">
                        ...
                        <input type="text" title="Street Address" data-optional="1" name="en_wd_origin_address" data-optional="1" placeholder="320 W. Lanier Ave, Ste 200" id="en_wd_origin_address">
                    ...
                    <div class="heading">
                        ...
                        <a href="#">
                            <h2 class="warehouse_heading pakage_notify_instore_warehouse heading_right"><?php echo esc_html($package_required); ?></h2>
                        </a>
                    </div>
                    ...
                    <div class="heading">
                        ...
                        <a href="#">
                            <h2 class="local-delivery-heading pakage_notify_local_warehouse heading_right"><?php echo esc_html($package_required); ?></h2>
                        </a>
                    </div>
                    ...
                    -->
                    <div class="form-btns">
                        <input type="submit" name="en_wd_submit_warehouse" value="Save" class="save_warehouse_form" onclick="return wwe_ltl_en_wd_save_warehouse();">
                    </div>
                </form>
            </div>
        </div>
