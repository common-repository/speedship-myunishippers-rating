 ...
 * @returns {Boolean}
 */
if (typeof wwe_ltl_en_wd_save_warehouse != "function") {
  function wwe_ltl_en_wd_save_warehouse() {
    ...
    var postForm = {
      action: "wwe_ltl_en_wd_save_warehouse",
        ...
        if (data.insert_qry == 1) {
          ...
          jQuery("tr[id=row_" + WarehpuseDataId + "]").html(
            '<td class="en_wd_warehouse_list_data">' +
              ...
              '</td><td class="en_wd_warehouse_list_data">' +
              data.origin_country +
              '</td><td class="en_wd_warehouse_list_data"><a href="javascript(0)" title="Edit" onclick="return wwe_ltl_en_wd_edit_warehouse(' +
              WarehpuseDataId +
              ')"><img src="' +
              script.pluginsUrl +
              '/ltl-freight-quotes-worldwide-express-edition-speedship/warehouse-dropship/wild/assets/images/edit.png"></a><a href="javascript(0)" title="Delete" onclick="return wwe_ltl_en_wd_delete_current_warehouse(' +
              WarehpuseDataId +
              ');"><img src="' +
              script.pluginsUrl +
              '/ltl-freight-quotes-worldwide-express-edition-speedship/warehouse-dropship/wild/assets/images/delete.png"></a></td>'
          );
        } else {
 ...
 * @returns {Boolean}
 */
if (typeof wwe_ltl_en_wd_delete_current_warehouse != "function") {
  function wwe_ltl_en_wd_delete_current_warehouse(e) {
    var tab = get_parameter_by_name("tab");
    var postForm = {
 ...
 * @returns {Boolean}
 */
if (typeof wwe_ltl_en_wd_edit_warehouse != "function") {
  function wwe_ltl_en_wd_edit_warehouse(e) {
    var postForm = {
      action: "wwe_ltl_en_wd_edit_warehouse",
      edit_id: e,
    };
    jQuery.ajax({
      type: "POST",
 ...
 * @returns {Boolean}
 */
if (typeof wwe_ltl_en_wd_save_dropship != "function") {
  function wwe_ltl_en_wd_save_dropship() {
    ...
    var postForm = {
      action: "wwe_ltl_en_wd_save_dropship",
        ...
        if (data.insert_qry == 1) {
          ...
          jQuery("tr[id=row_" + WarehpuseDataId + "]").html(
            '<td class="en_wd_dropship_list_data">' +
              ...
              '</td><td class="en_wd_dropship_list_data">' +
              data.origin_country +
              '</td><td class="en_wd_dropship_list_data"><a href="javascript(0)" title="Edit" onclick="return wwe_ltl_en_wd_edit_dropship(' +
              WarehpuseDataId +
              ')"><img src="' +
              script.pluginsUrl +
              '/ltl-freight-quotes-worldwide-express-edition-speedship/warehouse-dropship/wild/assets/images/edit.png"></a><a href="javascript(0)" title="Delete" onclick="return wwe_ltl_en_wd_delete_current_dropship(' +
              WarehpuseDataId +
              ');"><img src="' +
              script.pluginsUrl +
              '/ltl-freight-quotes-worldwide-express-edition-speedship/warehouse-dropship/wild/assets/images/delete.png"></a></td>'
 ...
 * @returns {Boolean}
 */
if (typeof wwe_ltl_en_wd_edit_dropship != "function") {
  function wwe_ltl_en_wd_edit_dropship(e) {
    var postForm = {
      action: "wwe_ltl_en_wd_edit_dropship",
      dropship_edit_id: e,
    };
    jQuery.ajax({
      type: "POST",
 ...
 * @returns {Boolean}
 */
if (typeof wwe_ltl_en_wd_delete_current_dropship != "function") {
  function wwe_ltl_en_wd_delete_current_dropship(e) {
    var id = e;
    ...
    jQuery(".confirm_delete").on("click", function () {
      ...
      return wwe_ltl_en_wd_confirm_delete_dropship(id);
    });
    return false;
  }
}
 ...
 * @returns {Boolean}
 */
if (typeof wwe_ltl_en_wd_confirm_delete_dropship != "function") {
  function wwe_ltl_en_wd_confirm_delete_dropship(e) {
    var tab = get_parameter_by_name("tab");
    var postForm = {
...
function stopSpecialCharacters(e) {
  // Allow: backspace, delete, tab, escape, enter and .
  if (
    jQuery.inArray(e.keyCode, [46, 9, 27, 13, 110, 190, 53, 189]) !== -1 ||
    // Allow: Ctrl+A, Command+A
    (e.keyCode === 65 && (e.ctrlKey === true || e.metaKey === true)) ||
    // Allow: home, end, left, right, down, up
    (e.keyCode >= 35 && e.keyCode <= 40)
