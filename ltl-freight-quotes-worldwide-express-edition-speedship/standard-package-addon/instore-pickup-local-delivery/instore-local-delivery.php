...
if (!class_exists("EnWweLTLWDQuotes")) {

    class EnWweLTLWDQuotes
    {

        public function __construct()
        {
            add_filter('en_wd_update_query_string', array($this, 'en_wd_update_query_string'), 10, 1);
            add_filter('en_wwe_ltl_wd_origin_array_set', array($this, 'en_wwe_ltl_wd_origin_array_set'), 10, 1);
            add_filter('en_wwe_ltl_wd_standard_plans', array($this, 'en_wd_standard_plans'), 10, 4);
         ...
         * @return array type
         */
        public function en_wwe_ltl_wd_origin_array_set($origin)
        {
