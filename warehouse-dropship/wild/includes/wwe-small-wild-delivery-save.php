...
if (!class_exists("EnWweSmallWooWdAddonsAjaxReqIncludes")) {
    ...
    class EnWweSmallWooWdAddonsAjaxReqIncludes
    {
        ...
        {
            add_action('wp_ajax_nopriv_en_wd_get_address', array($this, 'speed_wild_get_address_api_ajax'));
            add_action('wp_ajax_en_wd_get_address', array($this, 'speed_wild_get_address_api_ajax'));
         ...
         */
        function speed_wild_get_address_api_ajax()
        {
            if (isset($_POST['origin_zip'])) {
                ...
                $accessLevel = 'address';
                $Speed_Get_sm_distance = new Speed_Get_sm_distance();
        ...
        function wwe_small_save_warehouse_ajax()
        {
            ...
            if ($validateData["city"] != 'Error') {
                ...
                speed_wwe_small_get_all_warehouse_dropship($addresses);
