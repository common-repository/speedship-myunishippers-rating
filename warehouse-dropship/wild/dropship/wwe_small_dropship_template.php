...
<script type="text/javascript">
    jQuery(document).ready(function() {
        ...
        jQuery("#en_wd_dropship_zip").keydown(function(e) {
            if (e.which != 96) {
                if (e.which != 8 && e.which != 0 && (e.which < 48 || e.which > 57) && (e.keyCode < 65 || e.keyCode > 90) && (e.keyCode < 97 || e.keyCode > 122)) {
                    return false;
                } else {
    ...
    function change_dropship_zip() {
        ...
        jQuery('#en_wd_dropship_city').css('background', 'rgba(255, 255, 255, 1) url("<?php echo plugins_url('assets/images/processing.gif', __FILE__); ?>") no-repeat scroll 50% 50%');
        jQuery('#en_wd_dropship_state').css('background', 'rgba(255, 255, 255, 1) url("<?php echo plugins_url('assets/images/processing.gif', __FILE__); ?>") no-repeat scroll 50% 50%');
        jQuery('.city_select_css').css('background', 'rgba(255, 255, 255, 1) url("<?php echo plugins_url('assets/images/processing.gif', __FILE__); ?>") no-repeat scroll 50% 50%');
        jQuery('#en_wd_dropship_country').css('background', 'rgba(255, 255, 255, 1) url("<?php echo plugins_url('assets/images/processing.gif', __FILE__); ?>") no-repeat scroll 50% 50%');
            ...
            <div class="content">
                ...
                <form method="post" id="add_dropships">
                    ...
                    <div class="en_wd_add_warehouse_input">
                        ...
                        <input type="text" title="Street Address" name="en_wd_dropship_address" data-optional="1" placeholder="320 W. Lanier Ave, Ste 200" id="en_wd_dropship_address">
                        <span class="en_wd_err"></span>
                    </div>
                    <div class="en_wd_add_warehouse_input">
                    ...
                    <div class="heading">
                        ...
                        <a href="#">
                            <h2 class="warehouse_heading pakage_notify_instore_dropship heading_right"><?php echo esc_html($package_required); ?></h2>
                        </a>
                    </div>
                    ...
                    <div class="en_wd_add_warehouse_input">
                        ...
                        <input type="text" class="<?php echo esc_attr($disabled); ?> en-phone-number" title="Phone number:" id="en-phone-number" placeholder="404-369-0680" data-optional="1" name="en-phone-number">
                    </div>
                    ...
                    <div class="heading">
                        ...
                        <a href="#">
                            <h2 class="local-delivery-heading pakage_notify_local_dropship heading_right"><?php echo esc_html($package_required); ?></h2>
                        </a>
                    </div>
